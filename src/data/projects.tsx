...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Agzaga",
    overview:
      "US-based e-commerce platform optimized for Core Web Vitals, 65% reduction in order processing errors, multi-marketplace sync (Walmart / eBay / Amazon), TaxCloud integration, zero-downtime Heroku deploys.",
  ...
  },
  {
    ...
    overview:
      "Contributed to training and evaluation pipelines on leading AI training platforms (Mindrift, Toloka, Turing). Work spans RLHF data structuring, supervised fine-tuning data, red-teaming exercises, and multi-modal evaluation across text, image, audio, and video.",
    ...
    highlights: [
      "Worked across multiple modalities - text, image, audio, and video within foundation-model training pipelines.",
      "Hands-on with RLHF, DPO, and supervised fine-tuning data workflows.",
      "Dataset curation, structuring, and quality assurance contributions for production-grade training corpora.",
      "Red-teaming and adversarial prompting exercises to surface model failure modes.",
